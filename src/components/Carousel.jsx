...
const Carousel = () => {
    ...
    const renderCards = () => {
        return initialCardData
            ...
            .map((card, index) => (
                <div key={index} className="w-full md:w-1/3 px-4 mb-8"> {/* Add px-4 for horizontal padding and mb-8 for bottom margin */}
                    <div className="">
                        <img
                            src={card.image}
                            alt={card.name}
    ...
    if (!isLargeScreen) {
        return null; // Do not render Carousel for screens below 1024
    }
